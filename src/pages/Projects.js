...
export default function Projects({ preload }) {
  ...
  return (
    <Container fluid className="page-coconut-bg flex-column align-items-center">
      ...
      <animated.section
        style={popOut}
        className="justify-content-center container-fluid p-4"
      >
        <Row>
          <Col md={6} className="p-3 d-flex justify-content-center">
            <animated.div
              onMouseMove={({ clientX: x, clientY: y }) =>
                setProps1({ xys: calc(x, y) })
              }
            ...
            >
              <Card className="card-width h-100 p-1">
                <a
                  href="https://gandor999.github.io/static-responsive-webstie/"
                  target="_blank"
                >
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text>
                    This is the first website project I made with Bootstrap,
                    CSS, and HTML.
                  </Card.Text>
                  <a
                    href="https://gandor999.github.io/static-responsive-webstie/"
          ...
          <Col md={6} className="p-3 d-flex justify-content-center">
            ...
            >
              <Card className="card-width h-100 p-1">
                <a
                  href="https://github.com/gandor999/eCommerce-API/tree/master"
                  target="_blank"
                >
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text>
                    This API was made using Node, Express, and Mongoose. The
                    database used was MongoDB Atlas so this is a NoSql DB.
                  </Card.Text>
                  <a
                    href="https://github.com/gandor999/eCommerce-API/tree/master"
                    target="_blank"
          ...
          <Col md={6} className="p-3 d-flex justify-content-center">
            ...
            >
              <Card className="card-width h-100 p-1">
                <a
                  href="https://e-commerce-client-side.vercel.app/"
                  target="_blank"
                >
                ...
                <Card.Body className="d-flex flex-column">
                  <Card.Title className="text-center">
                    eCommerce Simulation Website
                  </Card.Title>
                  <Card.Text>
                    This is the first project that I made with React. It has
                    CRUD operations with the admin account and CR operations for
                    a normal user. It simulates a simple eCommerce website.
                  </Card.Text>
                  <a
                    href="https://e-commerce-client-side.vercel.app/"
                    className="mt-auto"
          ...
          <Col md={6} className="p-3 d-flex justify-content-center">
            ...
            >
              <Card className="card-width h-100 p-1">
                <a
                  href="https://tic-tac-toe-ten-beryl.vercel.app/"
                  target="_blank"
                >
